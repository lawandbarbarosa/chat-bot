...
def main():
    ...
    st.markdown('<div class="welcome-message">Welcome to the chatbot. Please type a message and press Enter to start the conversation.</div>', unsafe_allow_html=True)
    ...
    for speaker, message in reversed(st.session_state.chat_history):
        ...
        chat_container += f'<div class="chat-bubble {bubble_class}">{message}</div>'
    chat_container += '</div>'
